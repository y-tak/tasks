...
* Author name : {y-tak}
* Codeship : {https://github.com/y-tak/tasks.git}

Example of Codeship badge. Please remove the example before you send us the link. 
[ ![Codeship Status for tschool/javaschoolexam](https://app.codeship.com/projects/bc6d5d50-b1cb-0137-d29a-2a550cdb8545/status?branch=master)](https://app.codeship.com/projects/363160)
